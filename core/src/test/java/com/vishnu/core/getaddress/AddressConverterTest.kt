...
class AddressConverterTest {
    ...
    private val apiEmptyAddressItem = Mockito.mock(ApiAddressItem::class.java)
    ...
    fun setUp() {
        ...
        whenever(apiEmptyAddressItem.addressString).thenReturn("")
    ...
    @Test
    fun `converter should not add empty address string to the Address data list`() {
        whenever(apiAddressData.addressList).thenReturn(
            listOf(
                apiAddressItem,
                apiEmptyAddressItem,
                apiAddressItem
